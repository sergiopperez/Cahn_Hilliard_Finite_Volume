...
def Euler_implicit_row_sym(rhor,rhor1,dx,dt,epsilon,ntimes,pot,theta,thetac,choicemob,bc,angle,j):
                       
    rhor1=np.concatenate((rhor1,np.flip(rhor1)))
